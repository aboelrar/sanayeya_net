package www.dm.sanayeya.net.view.Scenario_client.Scenario_main_screen.Controller.Secnario_Categories.Industerial_services.Scenario_industerial_rate.controller;
...
public class industerial_rate extends AppCompatActivity implements View.OnClickListener, NetworkInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new regist_network_broadcast().registerNetworkBroadcastForNougat(industerial_rate.this);
    ...
    void call_api() {
        if (rate.equals("nodata")) {
            ...
            new Apicalls(this, this).industerial_rate(getIntent().getStringExtra("shop_id"), rate, writeFeedback.getText().toString());
        }
    }
}
