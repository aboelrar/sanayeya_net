package www.dm.sanayeya.net.view.Scenario_client.Scenario_main_screen.Controller.Secnario_Categories.home_services.Scenario_home_services_rate.controller;
...
public class home_services_rate extends AppCompatActivity implements View.OnClickListener, NetworkInterface {
    ...
    void call_api() {
        if (rate.equals("nodata")) {
            ...
            new Apicalls(this, this).home_services_rate(getIntent().getStringExtra("shop_id"), rate, writeFeedback.getText().toString());
        }
    }
}
